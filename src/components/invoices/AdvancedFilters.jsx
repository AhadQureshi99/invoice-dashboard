...
const AdvancedFilters = ({ onApply }) => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-5">
      <p className="text-sm font-bold text-[#0e5f4f] mb-4">Advanced Filters</p>

      <div className="flex items-end gap-4 flex-wrap">
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-semibold text-gray-600">Status</label>
          <select value={f.status} onChange={set('status')} className="border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#0e5f4f]/20 focus:border-[#0e5f4f] bg-white cursor-pointer min-w-[130px]">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <select value={f.range} onChange={set('range')} className="border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#0e5f4f]/20 focus:border-[#0e5f4f] bg-white cursor-pointer min-w-[130px]">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <select value={f.type} onChange={set('type')} className="border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#0e5f4f]/20 focus:border-[#0e5f4f] bg-white cursor-pointer min-w-[120px]">
        ...
        <div className="flex items-center gap-2 ml-auto">
          <button onClick={apply} className="bg-[#0e5f4f] hover:bg-[#083f33] text-white rounded-lg px-5 py-2 text-sm font-semibold transition-colors">
            Apply Filters
          </button>
