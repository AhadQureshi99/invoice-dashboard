...
const AboutWhy = () => (
  <section className="w-full bg-white py-14">
    <div className="max-w-6xl mx-auto px-6">
      <h2 className="text-[1.4rem] font-bold text-[#1e3a5f] mb-6">Why TaxGuard?</h2>
      ...
      <div className="flex gap-4 mb-4">
        ...
        <div className="flex-[2] border border-gray-200 rounded-2xl p-6 flex flex-col gap-3 overflow-hidden">
          ...
          <h3 className="text-[#1e3a5f] font-bold text-[0.95rem]">Institutional Heritage</h3>
        ...
        <div className="flex-1 bg-[#0d1e35] rounded-2xl p-6 flex flex-col">
          <div className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center mb-3">
            <HiOutlineWrenchScrewdriver className="w-5 h-5 text-emerald-400" />
          </div>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-white/[0.08] mt-4">
            ...
            <span className="text-yellow-300 font-bold text-sm">99.98%</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 border border-gray-200 rounded-2xl p-6">
          ...
          <h3 className="text-[#1e3a5f] font-bold text-[0.95rem] mb-2">Security First</h3>
          <p className="text-gray-500 text-sm leading-relaxed">
        ...
        <div className="flex-[2] border border-gray-200 rounded-2xl p-6 flex items-start justify-between gap-6">
          <div className="flex-1">
            <h3 className="text-[#1e3a5f] font-bold text-[0.95rem] mb-2">SOC2 Type II Certified</h3>
            <p className="text-gray-500 text-sm leading-relaxed">
