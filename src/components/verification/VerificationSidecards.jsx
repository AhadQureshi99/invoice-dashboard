...
const FileIcon = () => (
  <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
    ...
    <path d="M11 10a2 2 0 012-2h8l6 6v12a2 2 0 01-2 2H13a2 2 0 01-2-2V10z" fill="#1e3a5f" />
    ...
    <div className="flex flex-col gap-4 flex-1 min-w-0">
      ...
      <div className="flex-1 bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex flex-col items-center text-center justify-center">
        ...
        <div className="flex flex-col gap-2 w-full">
          ...
          {onBulkClick && (
            <button onClick={onBulkClick} className="bg-[#1e3a5f] hover:bg-[#0f2040] text-white rounded-lg px-4 py-2 text-xs font-semibold transition-colors">
              Switch to Bulk Tab
            </button>
          )}
        </div>
      ...
      <div className="flex-1 bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex flex-col items-center text-center justify-center">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="bg-[#1e3a5f] hover:bg-[#0f2040] text-white rounded-lg px-4 py-2 text-xs font-semibold transition-colors w-full text-center"
        >
          API Documentation
        </a>
      </div>
