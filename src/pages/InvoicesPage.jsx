        ...
        <main className="flex-1 min-h-0 overflow-y-auto px-3 sm:px-6 py-4 sm:py-6">
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                <h1 className="text-2xl font-bold text-[#0e5f4f] leading-tight">Invoice Upload &amp; Validation</h1>
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className={`flex items-center gap-1.5 border rounded-xl px-4 py-2.5 text-sm font-semibold transition-colors shadow-sm ${
                    showFilters ? 'bg-[#0e5f4f] text-white border-[#0e5f4f]' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'
                  }`}
                >
